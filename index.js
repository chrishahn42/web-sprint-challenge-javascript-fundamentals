...
nestedfunction has access to the internal variable because the function was created in the same scope as the data
...
const zooAnimals = [
 ...
 zooanimals.foreach (animal_name: => console.log(n= "name:"{}))
  }
